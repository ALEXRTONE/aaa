        ...
        <div style={{height: '100%'}}> 
            ...
            <div style={{height: '100%'}} className="flex flex-row">
                ...
                <div className="profileContainer" style={style.profile}>
                    ...
                    <p><strong>Usuario:</strong> <span id="perfilUsuarioNombre">{user.username}</span></p>
                    <p><strong>Correo:</strong> <span id="perfilUsuarioCorreo">{user.email}</span></p>
                    <p><strong>Tipo de cuenta:</strong> <span id="perfilUsuarioTipo">{user.membresia.toUpperCase()}</span></p>
                    ...
                    { user.membresia.toUpperCase() === 'PRO' ?
                        ...
                        : 
                        <a href="https://buy.stripe.com/test_bJe4gBbiT8mc81d1AocAo02" target="_blank" rel="noopener noreferrer"><button type="button" className="focus:outline-none text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-600">Activar membresía</button></a>
                    }
